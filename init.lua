...
local function noita_event_debug()
  Coil.add(function()
    while true do
      ...
      -- NoitaEvent.Call("FungalShift", {})
      -- NoitaEvent.Call("Healing", {})
      -- NoitaEvent.Call("HeavySpread", {})
      -- NoitaEvent.Call("HelloDeer", {})
      -- NoitaEvent.Call("Hello", {})
      ...
      -- NoitaEvent.Call("SpawnSkoude", { used_by = 'noita' }) --secret
      -- NoitaEvent.Call("SpawnSteve", { used_by = 'noita' }) --secret
      -- NoitaEvent.Call("SpawnWater", {})
