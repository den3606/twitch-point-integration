...
local function noita_event_debug()
  local function add_events()
    ...
    -- Lume.push(NOITA_TASKS, {event_name = "GalleryPunch", event_data = { used_by = 'noita', message = 'testMessage' }})
    ...
    -- Lume.push(NOITA_TASKS, {event_name = "KusozakoBomb", event_data = { used_by = 'noita', message = 'testMessage' }})
    -- Lume.push(NOITA_TASKS, {event_name = "MovementControl", event_data = { used_by = 'noita', message = 'testMessage' }})
    -- Lume.push(NOITA_TASKS, {event_name = "MovementControl", event_data = { used_by = 'noita', message = 'up' }})
    -- Lume.push(NOITA_TASKS, {event_name = "MovementControl", event_data = { used_by = 'noita', message = 'down' }})
    -- Lume.push(NOITA_TASKS, {event_name = "MovementControl", event_data = { used_by = 'noita', message = 'left' }})
    -- Lume.push(NOITA_TASKS, {event_name = "MovementControl", event_data = { used_by = 'noita', message = 'right' }})
    ...
    -- Lume.push(NOITA_TASKS, {event_name = "SuperKusozakoBomb", event_data = { used_by = 'noita', message = 'testMessage' }})
    ...
    -- Lume.push(NOITA_TASKS, {event_name = "StallShop", event_data = { used_by = 'noita', message = 'testMessage' }})
