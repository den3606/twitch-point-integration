...
local function noita_event_debug()
  Coil.add(function()
    while true do
      Coil.wait(60)
      -- NoitaEvent.Call("Berserk", { used_by = 'noita', message = 'testMessage' })
      -- NoitaEvent.Call("Blindness", { used_by = 'noita', message = 'testMessage' })
      -- NoitaEvent.Call("Bomberman", { used_by = 'noita', message = 'testMessage' })
      -- NoitaEvent.Call("FungalShift", { used_by = 'noita', message = 'testMessage' })
      -- NoitaEvent.Call("Healing", { used_by = 'noita', message = 'testMessage' })
      -- NoitaEvent.Call("HeavySpread", { used_by = 'noita', message = 'testMessage' })
      -- NoitaEvent.Call("HelloDeer", { used_by = 'noita', message = 'testMessage' })
      -- NoitaEvent.Call("Hello", { used_by = 'noita', message = 'testMessage' })
      -- NoitaEvent.Call("MovementControll", { used_by = 'noita', message = 'testMessage' }) -- Note: unimplemented
      -- NoitaEvent.Call("Neutralized", { used_by = 'noita', message = 'testMessage' })
      -- NoitaEvent.Call("PotionGift", { used_by = 'noita', message = 'testMessage' })
      -- NoitaEvent.Call("RandomAll", { used_by = 'noita', message = 'testMessage' })
      -- NoitaEvent.Call("RandomSpellx10", { used_by = 'noita', message = 'testMessage' })
      -- NoitaEvent.Call("RandomSpell", { used_by = 'noita', message = 'testMessage' })
      -- NoitaEvent.Call("RussianRoolet", { used_by = 'noita', message = 'testMessage' })
      -- NoitaEvent.Call("SpawnRandomEnemy", { used_by = 'noita', message = 'testMessage' })
      -- NoitaEvent.Call("SpawnSkoude", { used_by = 'noita', message = 'testMessage' }) --secret
      -- NoitaEvent.Call("SpawnSteve", { used_by = 'noita', message = 'testMessage' }) --secret
      -- NoitaEvent.Call("SpawnWater", { used_by = 'noita', message = 'testMessage' })
      -- NoitaEvent.Call("Stretch", { used_by = 'noita', message = 'testMessage' })
      -- NoitaEvent.Call("SuperRecoil", { used_by = 'noita', message = 'testMessage' })
      -- NoitaEvent.Call("SuperRussianRoolet", { used_by = 'noita', message = 'testMessage' })
      -- NoitaEvent.Call("TPIShop", { used_by = 'noita', message = 'testMessage' })
      -- NoitaEvent.Call("TrailAcid", { used_by = 'noita', message = 'testMessage' })
      -- NoitaEvent.Call("TrailLava", { used_by = 'noita', message = 'testMessage' })
      -- NoitaEvent.Call("TrailPoison", { used_by = 'noita', message = 'testMessage' })
      -- NoitaEvent.Call("TrailWater", { used_by = 'noita', message = 'testMessage' })
      -- NoitaEvent.Call("Twitchy", { used_by = 'noita', message = 'testMessage' })
    end
  end)
end
